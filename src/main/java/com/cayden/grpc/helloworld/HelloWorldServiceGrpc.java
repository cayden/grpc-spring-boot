package com.cayden.grpc.helloworld;
...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.cayden.grpc.helloworld.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getSayHelloMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.cayden.grpc.helloworld.Person,
      com.cayden.grpc.helloworld.Greeting> METHOD_SAY_HELLO = getSayHelloMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.cayden.grpc.helloworld.Person,
      com.cayden.grpc.helloworld.Greeting> getSayHelloMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.cayden.grpc.helloworld.Person,
      com.cayden.grpc.helloworld.Greeting> getSayHelloMethod() {
    return getSayHelloMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.cayden.grpc.helloworld.Person,
      com.cayden.grpc.helloworld.Greeting> getSayHelloMethodHelper() {
    io.grpc.MethodDescriptor<com.cayden.grpc.helloworld.Person, com.cayden.grpc.helloworld.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.cayden.grpc.helloworld.Person, com.cayden.grpc.helloworld.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.cayden.grpc.helloworld.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cayden.grpc.helloworld.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cayden.grpc.helloworld.Greeting.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.cayden.grpc.helloworld.Person request,
        io.grpc.stub.StreamObserver<com.cayden.grpc.helloworld.Greeting> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.cayden.grpc.helloworld.Person,
                com.cayden.grpc.helloworld.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public com.cayden.grpc.helloworld.Greeting sayHello(com.cayden.grpc.helloworld.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cayden.grpc.helloworld.Greeting> sayHello(
        com.cayden.grpc.helloworld.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.cayden.grpc.helloworld.Person) request,
              (io.grpc.stub.StreamObserver<com.cayden.grpc.helloworld.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.cayden.grpc.helloworld.HelloWorld.getDescriptor();
    }
